...
* [`example-multi-js serial`](#example-multi-js-serial)
...
_See code: [src/commands/serial/index.js](https://github.com/oclif/example-multi-js/blob/v1.10.6/src/commands/serial/index.js)_
<!-- commandsstop -->
